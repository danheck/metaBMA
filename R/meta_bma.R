...
#' @param tau \code{prior} distribution on the standard deviation \eqn{\tau}
...
#' @param rscale_discrete scale parameter of the JZS prior for discrete moderators.
#' @param rscale_contin scale parameter of the JZS prior for the continuous covariates.
...
#' @param summarize how to estimate parameter summaries (mean, median, SD, etc.):
